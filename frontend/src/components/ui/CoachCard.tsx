    ...
    >
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          {/* Возраст · город */}
          <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-0.5 font-mono text-xs text-steel-dim">
          ...
          {/* Клуб */}
          {coach.club_name && (
            <div className="mt-2 flex items-center gap-1.5 truncate border-t border-steel-dim/15 pt-2 text-xs text-steel-dim">
              <svg width="11" height="11" viewBox="0 0 14 14" fill="none" className="flex-shrink-0">
